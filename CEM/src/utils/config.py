...
parser.add_argument("--dataset", default="dataset_preproc_link.p", type=str, help="Data File")
parser.add_argument("--save_path", type=str, default="/saved/cem_comfact/")
parser.add_argument("--model_path", type=str, default="/saved/cem_comfact/")
parser.add_argument("--save_path_dataset", type=str, default="/saved/")
